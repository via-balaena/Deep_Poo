...
## Scope
- Bins: overlay_labels, prune_empty, warehouse_etl/export/cmd, single_infer, gpu_probe (shared-ish; `gpu-windows` is a stub for now); app-facing bins gated by features (datagen_scheduler, tui, datagen).
